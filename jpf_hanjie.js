...
// Switch statement to determine which puzzle button triggerd this function
switch (puzzleID) {
   case "puzzle1": 
      document.getElementById("puzzle").innerHTML = drawPuzzle(puzzle1Hint, puzzle1Rating, puzzle1);
   break;
...
function setupPuzzle() {
  ...
  setTimeout(
     function() {
         ...
         for(var i = 0; i < puzzleCells.length; i++) {
            if (puzzleCells[i].style.backgroundColor === "rgb(225, 211, 211 ") {
...
function setBackground(e) {
   ...
   // Set cell background based on the keyboard key
   if(e.shiftKey){
...
// Prevent the default action of selecting the table text
e.preventDefault();
}
